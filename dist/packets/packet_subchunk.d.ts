...
export interface SubchunkPacket {
    ...
    entries: {
        cache_enabled: "true";
        value: SubChunkEntryWithCaching;
    } | {
        cache_enabled: "false";
        value: SubChunkEntryWithoutCaching;
    };
}
...
export type SubChunkEntryWithCaching = {
    ...
    render_heightmap: {
        render_heightmap_type: "has_data";
        value: any;
    };
    blob_id: number;
}[];
...
export declare const SubchunkPacketInfo: import("./metadata").PacketMetadata;
