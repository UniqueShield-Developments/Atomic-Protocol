...
import type { ClientboundDataStorePacket } from "./packets/packet_clientbound_data_store";
...
export interface Events {
  ...
  /**
   * Event for ClientboundDataStorePacket.
   */
  clientbound_data_store: (packet: ClientboundDataStorePacket) => void;
